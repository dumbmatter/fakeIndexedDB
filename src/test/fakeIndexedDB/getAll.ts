...
describe("getAll", () => {
    ...
    it("should work on index", (done) => {
        const request = db.transaction("store").objectStore("store").index("content").getAll();
        request.onsuccess = (e) => {
            assert.equal(e.target.result.length, 10);
            done();
        };
    ...
    it("should work with query parameter", (done) => {
        const request = db.transaction("store").objectStore("store").getAll(FDBKeyRange.bound(2, 5));
        request.onsuccess = (e) => {
    ...
    it("should work with count parameter", (done) => {
        const request = db.transaction("store").objectStore("store").getAll(null, 3);
        request.onsuccess = (e) => {
    ...
    it("should work with query and count parameters", (done) => {
        const request = db.transaction("store").objectStore("store").getAll(FDBKeyRange.lowerBound(6), 3);
        request.onsuccess = (e) => {
            assert.equal(e.target.result.length, 3);
...
describe("getAllKeys", () => {
    ...
    it("should work on index", (done) => {
        const request = db.transaction("store").objectStore("store").index("content").getAllKeys();
        request.onsuccess = (e) => {
            assert.equal(e.target.result.length, 10);
            done();
        };
    ...
    it("should work with query parameter", (done) => {
        const request = db.transaction("store").objectStore("store").getAllKeys(FDBKeyRange.bound(2, 5));
        request.onsuccess = (e) => {
            assert.equal(e.target.result.length, 4);
    ...
    it("should work with count parameter", (done) => {
        const request = db.transaction("store").objectStore("store").getAllKeys(null, 3);
        request.onsuccess = (e) => {
            assert.equal(e.target.result.length, 3);
    ...
    it("should work with query and count parameters", (done) => {
        const request = db.transaction("store").objectStore("store").getAllKeys(FDBKeyRange.lowerBound(6), 3);
        request.onsuccess = (e) => {
            assert.equal(e.target.result.length, 3);
