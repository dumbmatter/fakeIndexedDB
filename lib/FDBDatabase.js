...
module.exports = function () {
    ...
    this.createObjectStore = function (name, optionalParameters) {
        var hasVersionchange = this._transactions.some(function (transaction) {
        ...
        var transaction = this._transactions.find(function (transaction) {
        ...
        this._objectStores[name] = objectStore;
