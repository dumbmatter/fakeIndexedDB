...
module.exports = function (database) {
    ...
    this.objectStoreNames = clone(database.objectStoreNames);
    ...
    this.createObjectStore = function (name, optionalParameters) {
        ...
        var objectStore = new ObjectStore(this._database, name, keyPath, autoIncrement);
        this.objectStoreNames.push(name);
        this._database.objectStoreNames.push(name);
