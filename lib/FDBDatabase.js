...
function FDBDatabase(rawDatabase) {
    ...
    // Polyfill the DOMStringList methods on objectStoreNames
    Object.defineProperty(this.objectStoreNames, 'item', {
        value: function(i) { return this[i]; }
    });
    Object.defineProperty(this.objectStoreNames, 'contains', {
        value: function(value) { return this.indexOf(value) >= 0; }
    });
