...
RecordStore.prototype.find = function (range, direction, f) {
    // The filter only makes things slower in this adapter, but it is here to ensure that `range` is actually properly defined, because other adapters will use it.
    return this.records.filter(function (record) {
