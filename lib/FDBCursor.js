...
module.exports = function (source, range, direction, request) {
    ...
    this._iterate = function (key) {
        ...
        if (!foundRecord) {
            ...
            if (sourceIsObjectStore) {
                ...
                this.value = clone(this.source.objectStore._rawObjectStore.getValue(foundRecord.value));
                this.primaryKey = clone(foundRecord.value);
            }
            this._gotValue = true;
            result = this;
        }
    ...
    this.update = function () {
        ...
        if (effectiveObjectStore.keyPath !== null) {
            var tempKey = extractKey(effectiveObjectStore.keyPath, this.value);
        ...
        return transaction._execRequestAsync(this, effectiveObjectStore._rawObjectStore.storeRecord.bind(effectiveObjectStore._rawObjectStore, record, false), this._request);
    };
    ...
    this.advance = function (count) {
        ...
        transaction._execRequestAsync(this.source, function () {
            var result;
    ...
    this.continue = function (key) {
        ...
        this._request.readyState = 'pending';
        transaction._execRequestAsync(this.source, this._iterate.bind(this, key), this._request);
