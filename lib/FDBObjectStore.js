...
module.exports = function (transaction, rawObjectStore) {
    ...
    this.indexNames = Object.keys(rawObjectStore.rawIndexes);
    ...
    this.delete = function (key) {
        ...
        return this.transaction._execRequestAsync(this, this._rawObjectStore.deleteRecord.bind(this._rawObjectStore, key));
    };
    ...
    this.clear = function () {
        ...
        return this.transaction._execRequestAsync(this, this._rawObjectStore.clear.bind(this._rawObjectStore));
    };
    ...
    this.openCursor = function (range, direction) {
        ...
        return this.transaction._execRequestAsync(this, cursor._iterate.bind(cursor), request);
    };
