...
module.exports = function (transaction, objectStore) {
    ...
    this.indexNames = clone(objectStore.indexNames); // Because for createIndex, "This method synchronously modifies the IDBObjectStore.indexNames property. However it only changes the IDBObjectStore.indexNames property on the IDBObjectStore instance on which it was called."
...
// Confirm range is valid key or keyRange
    ...
    this.createIndex = function (name, keyPath, optionalParameters) {
        ...
        var hasVersionchange = this._objectStore.database.transactions.some(function (transaction) {
        ...
        var transaction = this._objectStore.database.transactions.find(function (transaction) {
