...
module.exports = function (transaction, rawObjectStore) {
    ...
    this.put = function (value, key) {
        ...
        return this.transaction._execRequestAsync({
            source: this,
            operation: this._rawObjectStore.storeRecord.bind(this._rawObjectStore, record, false)
        });
    };
    ...
    this.add = function (value, key) {
        ...
        return this.transaction._execRequestAsync({
            source: this,
            operation: this._rawObjectStore.storeRecord.bind(this._rawObjectStore, record, true),
            rollback: function (keyGeneratorBefore) {
                this._rawObjectStore.deleteRecord(record.key);
                this._rawObjectStore.keyGenerator.num = keyGeneratorBefore;
            }.bind(this, this._rawObjectStore.keyGenerator.num)
        });
    };
    ...
    this.delete = function (key) {
        ...
        return this.transaction._execRequestAsync({
            source: this,
            operation: this._rawObjectStore.deleteRecord.bind(this._rawObjectStore, key)
        });
    };
    ...
    this.clear = function () {
        ...
        return this.transaction._execRequestAsync({
            source: this,
            operation: this._rawObjectStore.clear.bind(this._rawObjectStore)
        });
    };
